...
public class EtatSanteOrphelin implements Serializable {
    ...
    public EtatSanteOrphelin() {
    }

    public EtatSanteOrphelin(Dossier dossier, Long id, String typeHandicape, int etatHandicape, String maladie, String suivieMaladieChronique, String suivieHandicape, String suivieMaladieRepetitif, double depense, String besoin, Orphelin orphelin) {
